      ...
      <div className="header-container">
        ...
        <div className="header-right">
          ...
          {customer ? (
            ...
            <Link to="/customer-login" className="icon-link" title="Login">
          ...
          {/* Wishlist Icon */}
          <Link to={customer ? "/dashboard/wishlist" : "/customer-login"} className="icon-link cart-link" title="Wishlist" onClick={() => setIsMenuOpen(false)}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
