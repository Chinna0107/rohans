...
const faqs = [
  { question: 'What categories does House of Ramya offer?', answer: 'House of Ramya offers premium sandals, shoes, flip flops, tshirts, and track pants — all carefully curated for style and comfort.' },
  ...
  return (
    <div className="faq-page">
      <div className="faq-container">
        ...
        <p className="faq-subtitle">Everything you need to know about House of Ramya</p>
